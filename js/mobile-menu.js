document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-q-navigation-list");
  const headerRef = document.querySelector(".w-q-header");
  const navigationRef = document.querySelector(".w-q-navigation");
